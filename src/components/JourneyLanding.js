                ...
                <div className="md:w-1/2">
                    ...
                    <div className="Journey-Heading  flex flex-row items-center ml-2 md:ml-0 -mt-24 md:-mt-20">
                        ...
                        <div data-aos="fade-right" className="text-white ml-8 overflow-hidden" >
                            <div className="text-lg md:text-xl">Full Stack Developer & UI/UX Designer(GFG-KIIT)</div>
                            <div className="text-base md:text-lg py-2" style={{ color: "#ACACAC" }}>December-2020 - Present</div>
                            <Flip x duration={5000} delay={2000}>
                                <div className="text-sm md:text-base md:pr-24  text-justify " style={{ color: "#B5B4B4" }}>I have contributed in the projects from all domains(Web, Android, UI/UX, ML) I am also responsible for leading some of the major events which the club puts forward for all the students and developers around the University.</div>
                            </Flip>
                        </div>
                    </div>
                ...
                <div className="mt-20 md:mt-0 md:w-1/2">
                    ...
                    <div className="Journey-Heading flex flex-row items-center ml-2 md:ml-0 -mt-36 md:-mt-24">
                        ...
                        <div data-aos="fade-left" className="text-white ml-8 overflow-hidden"  >
                            <div className="text-lg md:text-xl">B.Tech Information Technology (KIIT) </div>
                            <div className="text-base md:text-lg py-2" style={{ color: "#ACACAC" }}>July-2019 - Present</div>
                            <Flip x duration={3000} delay={1000}>
                            <div className="text-sm md:text-base md:pr-24  text-justify" style={{ color: "#B5B4B4" }}>I am a 3rd year IT student , currently studying in KIIT. I secured 8.5 CGPA in my 2nd Year. I have started doing development stuffs from mid of my 1st year and development facinated me a lot.
