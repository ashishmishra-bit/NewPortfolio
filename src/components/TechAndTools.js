            ...
            <div className="flex flex-col md:flex-row-reverse my-20 md:my-40">
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                    <div className="flex flex-row justify-center">
                        ...
                        <div className="maze ml-0.5 md:ml-1" style={{backgroundImage:`url(${Django})`}}></div>
                        <div className="maze ml-0.5 md:ml-1" style={{backgroundImage:`url(${Java})`}}></div>
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                    <div className="flex flex-row justify-center">
                        ...
                        <div className="maze ml-0.5 md:ml-1" style={{backgroundImage:`url(${mysql})`}}></div>
                        <div className="maze ml-0.5 md:ml-1" style={{backgroundImage:`url(${mongodb})`}}></div>
                    </div>
                    <div className="flex flex-row justify-center -mt-5">
                    <div className="maze mt-1 md:mt-0" style={{backgroundImage:`url(${postgresql})`}}></div>
                    <div className="maze mt-1 md:mt-0 ml-0.5 md:ml-1" style={{backgroundImage:`url(${oracle})`}}></div>
                    </div>
                </div>
            </div>
            <div className="flex flex-col md:flex-row-reverse my-20 md:my-40">
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                    <div className="flex flex-row justify-center">
                        ...
                        <div className="maze ml-0.5 md:ml-1" style={{backgroundImage:`url(${python})`}}></div>
                    </div>
                    <div className="flex flex-row justify-center -mt-5">
