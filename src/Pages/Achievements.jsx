    ...
    return (
        <div>
            ...
            <div className="home-section pb-20">
                ...
                <div className="flex flex-row justify-between mx-28 mb-16" style={{color:"#979797"}}>
                    {/* HACKERRANK CARD */}
                    <div className="competetive-card">
                        <div className="flex flex-row items-center">
                            <img src={HackerRankLogo} alt="HackerRankLogo" style={{width:"40px",height:"40px"}} />
                            <span className="text-lg font-semibold ml-5">HackerRank</span>
                        </div>

                        <p  className="text-lg font-semibold mt-5 mb-2">Badges</p>
                        <div className="flex flex-row justify-center">
                            <img src={problemSolvingBadge} alt="problemSolvingBadge" style={{width:"45px",height:"35px"}} />
                            <img src={CppBadge} alt="CppBadge" className="ml-3" style={{width:"45px",height:"35px"}} />
                            <img src={JavaBadge} alt="JavaBadge" className="ml-3" style={{width:"45px",height:"35px"}} />
                            <img src={DaysOfCodingBadge} alt="DaysOfCodingBadge" className="ml-3" style={{width:"45px",height:"35px"}} />
                        </div>
